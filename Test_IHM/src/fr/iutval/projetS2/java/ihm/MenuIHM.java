...
import Jeu_Console.Option;
import Jeu_Console.Regles;
import Jeu_Console.TableScore;
...
public class MenuIHM implements Runnable, ActionListener, KeyListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == Jouer) {
			FenetreChoixDuNiveauEtPseudo fenetreDebutJeu= new FenetreChoixDuNiveauEtPseudo();
